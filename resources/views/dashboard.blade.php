<x-layout>
    ...
    <div class="flex md:justify-between justify-center gap-2 flex-wrap mt-5">
        <a href="/angkatan" class=" w-[85%] md:w-[46%] xl:w-[23%]">
        ...
        <a href="/sekolah" class="w-[85%] md:w-[46%] xl:w-[23%]">
            <div class="h-40 rounded-2xl bg-white flex mt-6 shadow-2xl hover:font-bold hover:bg-blue-500 transition duration-500">
                <h4 class="text-3xl m-auto">Data Sekolah</h4>
            </div>
        </a>

        <a href="#" class="w-[85%] md:w-[46%] xl:w-[23%]">
            <div class="h-40 rounded-2xl bg-white flex mt-6 shadow-2xl hover:font-bold hover:bg-blue-500 transition duration-500">
                <h4 class="text-3xl m-auto">Data Angkatan</h4>
            </div>
        </a>
