...
<body>
    <div class="max-w-sm mx-auto bg-slate-50 shadow-lg rounded-lg p-8 mt-32 md:max-w-md lg:max-w-lg">
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <div class="mt-6">
                <button type="submit" class="w-full bg-blue-500 text-white font-medium py-2 px-4 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Login</button>
            </div>
        </form>
        
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600">Don't have an account?</p>
            <a href="{{ route('register') }}" class="inline-block bg-gray-100 text-blue-500 hover:bg-gray-200 px-4 py-2 rounded-md text-sm font-medium mt-2">Register</a>
        </div>
    </div>
